...
const  user: User = new User('Gus', 21)
user.showName() 
...
/**
 * Abstração, capacidade de abstrair, de criar um modelo de algo do mundo real
 * Herança, capacidade de criar uma classe que herda de outra classe
 * Polimorfismo, capacidade de criar métodos com o mesmo nome, mas com comportamentos diferentes
 * 
 **/